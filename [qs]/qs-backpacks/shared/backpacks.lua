...
Config.Items = {
     ['duffle1'] = {      --- Item name
          slots = 14,      -- Change in `qs-inventory/server/custom/GiveItemToPlayer.lua`
          weight = 60000, -- Change in `qs-inventory/server/custom/GiveItemToPlayer.lua`
     ...
     ['duffle2'] = {
          slots = 28,      -- Change in `qs-inventory/server/custom/GiveItemToPlayer.lua`
          weight = 120000, -- Change in `qs-inventory/server/custom/GiveItemToPlayer.lua`
          cloth = {
               male = {
