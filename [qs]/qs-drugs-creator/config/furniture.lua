Config.Furniture = {
    ...
    ['weed'] = {
        label = 'Weed',
        img = './assets/img/decorate/categories/rooms/weed/weed.svg',
        navigation = 4,
        dynamic = true,
        dynamicIcon = './assets/img/decorate/categories/rooms/weed/weed.svg',
        css = {
            zIndex = 3,
            top = 7.5,
            left = 9.5,
        ...
        items = {
            [1] = {
                ['img'] = './assets/img/decorate/categories/rooms/weed/items/bkr_prop_weed_table_01a.png',
                ['object'] = 'bkr_prop_weed_table_01a',
                ['price'] = 150,
                ['label'] = 'Weed Table 01a',
                ['description'] = 'Ideal table for creating weed! Oh wait this is... illegal?',
                ['colorlabel'] = 'Single',
                ['colors'] = {},
                ['type'] = 'drug',
                ['drugType'] = 'weed'
    ...
    ['cocaine'] = {
        label = 'Cocaine',
        img = './assets/img/decorate/categories/rooms/cocaine/cocaine.svg',
        navigation = 4,
        dynamic = true,
        dynamicIcon = './assets/img/decorate/categories/rooms/cocaine/cocaine.svg',
        css = {
            zIndex = 3,
            top = 7.5,
            left = 9.5,
        ...
        items = {
            [1] = {
                ['img'] = './assets/img/decorate/categories/rooms/cocaine/items/bkr_prop_coke_table01a.png',
                ['object'] = 'bkr_prop_coke_table01a',
                ['price'] = 150,
                ['label'] = 'Cocaine Table 01a',
                ['description'] = 'The ultimate board where wild unicorns are cooked!',
                ['colorlabel'] = 'Single',
                ['colors'] = {},
                ['type'] = 'drug',
                ['drugType'] = 'cocaine'
    ...
    ['chenmicals'] = {
        label = 'Chemicals',
        img = './assets/img/decorate/categories/rooms/chemicals/chemicals.svg',
        navigation = 4,
        dynamic = true,
        dynamicIcon = './assets/img/decorate/categories/rooms/chemicals/chemicals.svg',
        css = {
            zIndex = 3,
            top = 7.5,
            left = 9.5,
        ...
        items = {
            ...
            [3] = {
                ['img'] = './assets/img/decorate/categories/rooms/chemicals/items/bkr_prop_meth_table01a.png',
...
local function processDrugWithoutScene(drugType, processType)
    local animationData = Config.DrugAnimations[drugType]
    if not animationData then
        Error('You didnt set the animation data for the drug type', drugType)
        return
    end
    animationData = animationData[processType]
    if not animationData then
        Error('You didnt set the animation data for the process type', drugType, processType)
        return
    end
...
local function processDrug(drugType, processType)
    if not sceneDrugs[drugType] then
        return processDrugWithoutScene(drugType, processType)
    end
    local action = Config.Process[drugType][processType]
    if not action then
