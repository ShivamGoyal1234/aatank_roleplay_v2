...
Config.phoneDistress = 'yseries'        -- Options: 'gks' (GKS Phone - ESX ONLY) / 'qs' (qs-smartphone) / 'd-p' (d-phone) / 'lb' (lb-phone) / 'rcore_dispatch' (RCore Dispatch) / 'qs_dispatch' (qs-dispatch) / 'cd_dispatch' (cd_dispatch) / 'redutzu_dispatch' (redutzu_dispatch) WILL REPLACE BUILT IN DISPATCH WITH PHONE DISPATCH / Add additonal dispatch in client/cl_customize.lua
...
Config.FuelSystem = 'cdn-fuel'           -- 'legacy' (LegacyFuel) / 'ox' (ox_fuel) / 'default'
...
Config.BleedoutTimer = 3 * minutes -- Time before it forces respawn
Config.CanAutoRespawn = false       -- If true, player will auto respawn at hospital after bleedout timer, else press E
Config.ChargeForRevive = {
    enabled = true,                -- Charge players to revive after the timer expires when they hold E to revive?
    cost = 1000,                     -- Cost to revive if enabled
...
Config.ReviveRewards = {
    ...
    no_injury = 1500,         -- If above enabled, how much reward for fully treated patient with no injury in diagnosis
    burned = 800,            -- How much if player is burned and revived without being treated
    beat = 600,              -- So on, so forth
    stabbed = 900,
    bleedout = 1000,          -- NEW
    shot = 1500,
}
...
Config.ReviveHealth = { -- How much health to deduct for those revived without proper treatment
    shot = 100,          -- Ex. If player is shot and revived without having the gunshots treated; they will respond with 60 health removed
    stabbed = 100,
    beat = 100,
    burned = 100
}

Config.ReviveTime = 20 * seconds   -- Time to revive player
Config.TreatmentTime = 15 * seconds -- Time to perform treatment
Config.DiagnoseTime = 10 * seconds  -- Time to diagnose patient
...
Config.Locations = {
    Pillbox = {
        RespawnPoint = { -- When player dies and bleeds out; they will revive at nearest hospital; Define the coords of this hospital here.
            coords = vec3(-811.75, -1233.56, 6.72),
            heading = 332.22,
        ...
        Blip = {
            Enabled = true,
            Coords = vec3(-828.55, -1218.20, 6.94),
            Sprite = 61,
            Color = 2,
            Scale = 1.0,
            String = 'Vespucci Hospital'
        },
        ...
        clockInAndOut = {
            ...
            coords = vec3(-817.32873535156, -1232.5577392578, 6.4827728271484), -- Location of where to go on and off duty(If not using target)
            ...
            target = {
                ...
                coords = vector3(-817.32873535156, -1232.5577392578, 6.4827728271484),
                heading = 337.07,
                width = 2.0,
                length = 1.0,
                minZ = 43.28 - 0.9,
        ...
        PersonalLocker = {
            ...
            coords = vec3(-796.05963134766, -1261.375, 5.6988434791565),   -- Location of where to access personal locker (If target is disabled)
            ...
            target = {
                enabled = true,                    -- If enabled, the location and distance above will be obsolete
                label = 'Access Locker',
                coords = vector3(-796.05963134766, -1261.375, 5.6988434791565),
                heading = 70.18,
                width = 2.0,
                length = 1.0,
                minZ = 43.38 - 0.9,
        ...
        BossMenu = {
            ...
            Coords = vec3(-792.68493652344, -1252.6041259766, 11.139928817749), -- Location of boss menu (If not using target)
        ...
        CheckIn = {                                      -- Hospital check-in
            ...
            Ped = 's_m_m_scientist_01',                  -- Check in ped
            Coords = vec3(-813.35, -1235.56, 6.72 - 0.9), -- Coords of ped
            Distance = 4.85,                             -- Distance to show textUI (If target is not enabled below)
            Heading = 0.00,                             -- Heading of ped
            ...
            Target = {
                enabled = true,                          -- Enable Target? (Can be customized in wasabi_bridge/customize/cl_customize.lua the target system)
                label = 'Check In',
                coords = vec3(-813.35, -1235.56, 6.72),
                heading = 63.26,
                distance = 5.0,
                width = 2.0,
                length = 1.0,
            ...
            RespawnNoBedLocation = { coords = vec3(-797.11, -1233.36, 7.65), heading = 339.02 }, -- Coords and heading of where to spawn player if DisableHospitalBeds is set to true or beds are full
            HospitalBeds = {
                --              { coords = vec3(332.62, -587.17, 42.84+0.3), heading = 160.0 },
                { coords = vec3(-796.89, -1233.33, 6.65), heading = 320.0 },
    			{ coords = vec3(-799.50, -1231.04, 6.65), heading = 320.0 },
    			{ coords = vec3(-802.44, -1228.79, 6.65),  heading = 320.0 },
    			{ coords = vec3(-805.36, -1226.40, 6.65), heading = 320.0 },
    			{ coords = vec3(-808.09, -1224.12, 6.65), heading = 320.0},
    			{ coords = vec3(-791.15, -1226.38, 6.65), heading = 140.0 },
    			{ coords = vec3(-793.44, -1224.61, 6.65), heading = 140.0 },
        ...
        Cloakroom = {
            Enabled = true,
            Coords = vector3(-806.37, -1220.29, 11.31), -- Coords of cloakroom
        ...
        MedicalSupplies = {                                                     -- EMS Shop for supplies
            ...
            Coords = vector3(0,0,0),                       -- Coords of ped/target
        ...
        Vehicles = {                                   -- Vehicle Garage
            ...
            Zone = {
                coords = vector3(-853.90, -1234.40, 6.91), -- Area to prompt vehicle garage
            ...
            Spawn = {
                land = {
                    coords = vec3(-853.90, -1234.40, 6.91),
                    heading = 322.41
                },
                air = {
                    coords = vec3(-849.54, -1237.56, 6.68),
                    heading = 289.29
                }
            },
            Options = {
                [0] = {                    -- Job grade as table name
                    ['Killer_ems1'] = {      -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'Kiler',
                        category = 'land', -- Options are 'land' and 'air'
                    },
                    ['Killer_ems2'] = {       -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'Killer 2',
                        category = 'land', -- Options are 'land' and 'air'
                    },
                    ['Killer_ems3'] = {         -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'Killer 3',
                        category = 'land',  -- Options are 'land' and 'air'
                    },
                    ['Killer_ems4'] = {         -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'Killer 4',
                        category = 'land',  -- Options are 'land' and 'air'
                    },
                    ['Killer_ems5'] = {         -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'Killer 5',
                        category = 'land',  -- Options are 'land' and 'air'
                    },
                    ['Killer_ems6'] = {         -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'Killer 6',
                        category = 'land',  -- Options are 'land' and 'air'
                    },
