...
Config.Locations = {
    ...
    trash = {
        vector3(-588.66, -425.51, 35.17),
    },
    fingerprint = {
        vector3(-584.27, -447.14, 31.16),
        vector3(-583.76, -447.30, 31.94),
    },
    evidence = {
        vector3(-570.77783203125, -441.56921386719, 31.315052032471),
        vector3(-583.45739746094, -441.55169677734, 31.320713043213),
        -- vector3(451.7031, -973.232, 30.689),
        -- vector3(455.1456, -985.462, 30.689),
    },
    stations = {
        { label = 'Police Station',        coords = vector4(-579.23, -422.83, 35.16, 228.04) },
