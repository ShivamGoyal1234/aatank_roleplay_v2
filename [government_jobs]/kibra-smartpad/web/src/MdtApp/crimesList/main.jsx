          ...
          onChange={(e) => setQuery(e.target.value)}></input>
            ...
            <div className={`cquery-box ${theme !== 'dark' ? 'cqbox':''}`}>
                <div className={`cquery-header ${theme !== 'dark' ? 'white-bold' : ''}`}>
                    <span onClick={() => SetPage('poffences')} className={`part-title2 ${theme !== 'dark' ? 'partd': ''}`}>{lang.poffences}</span>
                    <span onClick={() => SetPage('toffences')} className={`part-title2 ${theme !== 'dark' ? 'partd': ''}`}>{lang.toffences}</span>
                </div>
