...
const Paramedics = ({officers, grades, lang, theme}) => {
    ...
    const [themeTab, setTheme] = useState(null);
    ...
    return (
        ...
        <div className='bothofthem'>
            <div style={{width: '51rem'}} className={`search-part ${themeTab !== 'dark' ? 'search-white':''}`}>
            ...
            <div className={`yenimenum ${themeTab !== 'dark' ? 'border-white':''}`}>
                <div className={`yenimenum-header ${themeTab !== 'dark' ? 'white-hed':''}`}>
                <div style={{width: '25rem'}} className={`header-menx ${themeTab !== 'dark' ? 'black-text' : ''}`}>
                Paramedic
                </div>
                <div style={{width: '12rem'}} className={`header-menx ${themeTab !== 'dark' ? 'black-text' : ''}`}>
                Rank
                </div>
                <div style={{width: '22rem',
    paddingRight: '2rem',
    justifyContent: 'end'}} className={`header-menx ${themeTab !== 'dark' ? 'black-text' : ''}`}>
                    Citizen ID
                </div>
                </div>
                ...
                return (
                    <div key={idx} className={`like-man ${themeTab !== 'dark' ? 'border-whitex':''}`}>
                    <div style={{ width: "35rem" }} className="like-man-part">
                        ...
                        <div className={`like-manxv ${themeTab !== 'dark' ? 'black-text':''}`}>
                    ...
                    <div style={{ width: "36rem" }} className="like-man-part">
                        <div className={`like-manx ${themeTab !== 'dark' ? 'black-text':''}`}>
                        <div
