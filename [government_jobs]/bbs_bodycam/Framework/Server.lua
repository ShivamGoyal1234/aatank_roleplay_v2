    ...
    elseif GetResourceState('qb-inventory') == 'started' or GetResourceState('ps-inventory') == 'started' then
        ...
        for govermentItem, _ in pairs(Config.ItemSettings.JobAssociatedItems) do
            items[govermentItem] = {
                ...
                weight = 20,
                type = 'item',
                image = govermentItem .. '.png', -- can be find in the /itemicons folder, move them to qb-inventory/html/images
                unique = true,
                useable = true,
                shouldClose = true,
                combinable = nil,
        ...
        for commercialItem, _ in pairs(Config.ItemSettings.CommercialUseItems) do
            items[commercialItem] = {
                ...
                weight = 20,
                type = 'item',
                image = commercialItem .. '.png', -- can be find in the /itemicons folder, move them to qb-inventory/html/images
                unique = true,
                useable = true,
                shouldClose = true,
                combinable = nil,
