...
Config.DebugPrints           = false     -- Show debug prints on consoles
Config.Notify                = "ox_lib"                                -- Notification system to use (supports: codem, esx, qb, okok, wasabi, t-notify, r_notify, pNotify, mythic, ox_lib) Checkout Framework/Client.lua to implement your own notification system
...
Config.Stations              = {        -- Default stations. AVOID having 2 stations within render distance of each other!!
    {
        Location = vector4(-593.32, -423.51, 34, 179.88),
        ...
        ControlAccess = {              -- Who can control the Station PC to switch POVs.
            ...
            Jobs = {
                ['police'] = true,                           -- jobs with specific grades
