...
qb_Config = {}
qb_Config.Keybind = 'F1' -- FiveM Keyboard, this is registered keymapping, so needs changed in keybindings if player already has this mapped.
qb_Config.Toggle = false -- use toggle mode. False requires hold of key
-- qb_Config.UseWhilstWalking = false -- deprecated by Config.Settings.UseWhilstWalking (on shared/config.lua)
...
qb_Config.MenuItems = {{
    ...
    --     grade = false -- Minimum job grade required to access this menu item
    -- },
    items = {
    --     {
    --     id = 'givenum',
