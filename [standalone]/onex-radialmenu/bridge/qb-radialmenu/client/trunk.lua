...
RegisterNetEvent('qb-trunk:client:KidnapGetIn', function(veh)
    ...
    if qb_Config.TrunkClasses[vehClass].allowed then
                    ...
                    if not isBusy then
                        if not isKidnapped then
                            if GetVehicleDoorAngleRatio(closestVehicle, 5) > 0 then
                                local offset = {
                                    x = qb_Config.TrunkClasses[vehClass].x,
                                    y = qb_Config.TrunkClasses[vehClass].y,
                                    z = qb_Config.TrunkClasses[vehClass].z
                                }
                                ...
                                AttachEntityToEntity(ped, closestVehicle, 0, offset.x, offset.y, offset.z, 0, 0, 40.0,
                                    1, 1, 1, 1, 1, 1)
