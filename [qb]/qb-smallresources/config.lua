...
Config.Discord = {
    ...
    applicationId = '1381184517171183727',                   -- The discord application id
    iconLarge = 'arp2',                               -- The name of the large icon
    iconLargeHoverText = '', -- The hover text of the large icon
    iconSmall = 'XXXX',                         -- The name of the small icon
    iconSmallHoverText = '', -- The hover text of the small icon
    updateRate = 20000,                                    -- How often the player count should be updated
    ...
    buttons = {
        {
            text = 'Connect Server',
            url = 'https://cfx.re/join/yld5z5'
        },
        {
            text = 'Discord',
            url = 'https://discord.gg/aatankrp'
        }
    }
}
...
Config.CarWash = {
    ...
    defaultPrice = 10000,                                                                                 -- default price for the carwash
    locations = {
        ...
        [5] = { coords = vector3(-943.49, -2062.99, 9.21), length = 11.8, width = 5.2, heading = 0 }   -- benny airport
    }
}
