...
Config.DrawTextSetup = {
    ...
    defaultButton = 'SLASH' -- see https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
}

Config.ClassColors = {
    ["D"] = { r = 180, g = 50, b = 50, a = 255 },    -- Muted Red
    ["C"] = { r = 180, g = 100, b = 50, a = 255 },   -- Muted Orange
    ["B"] = { r = 50, g = 180, b = 50, a = 255 },    -- Muted Green
    ["A"] = { r = 50, g = 50, b = 180, a = 255 },    -- Muted Blue
