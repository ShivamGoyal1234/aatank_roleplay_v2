...
function getVehicleInfo(vehicle)
    ...
    debugLog("Vehicle Model:", model)
    local vehicleData = QBCore.Shared.VehicleHashes[model]
    debugLog("Vehicle Data:", json.encode(vehicleData, {indent=true}))
    local class = vehicleData and vehicleData.class or ""
...
local function checkPerformance()
    ...
    if veh == 0 then
        ...
        notify("This car is a "..class, 'success')
