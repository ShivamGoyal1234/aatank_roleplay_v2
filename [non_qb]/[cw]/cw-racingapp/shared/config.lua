...
Config.Permissions = {
    racer = {
        ...
        startReversed = false,       -- can start races with reversed track (It makes NO sense that this is even needed as an auth, but it was paid for so here it is. Leave it as true)
