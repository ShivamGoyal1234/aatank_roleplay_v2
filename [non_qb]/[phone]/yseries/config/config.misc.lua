...
Config.UpdateUserPhoneNumber = true     -- Whether to update the phone number in the users/players(charinfo) table in the database when the phone is setup(won't work for unique phones). Default *false.

Config.Maps = {}
Config.Maps.RealTimeLocation = true   -- Whether to sync the location of the player with the map app in realtime.
